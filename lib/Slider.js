...
/**
    ...
    */
disableScroll:_react.PropTypes.func,

/**
    * Callback to enable any parent scroll views
    */
enableScroll:_react.PropTypes.func,
...
/**
     ...
     */
createThumbMiddleware:_react.PropTypes.func},
...
_createWrappedThumbView:function _createWrappedThumbView(view){var
createThumbMiddleware=this.props.createThumbMiddleware;
...
_react2.default.createElement(_reactNative.Animated.View,{style:[mainStyles.track,trackStyle,minimumTrackStyle]}),
_react2.default.createElement(_reactNative.Animated.View,{
onLayout:this._measureThumb,
style:[
{marginTop:-(trackSize.height+thumbSize.height)/2},
mainStyles.thumb,thumbStyle,_extends({left:thumbLeft},valueVisibleStyle)]},


this._createWrappedThumbView(_react2.default.createElement(_reactNative.View,{
style:[
